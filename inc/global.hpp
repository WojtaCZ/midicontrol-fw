...
#define PORT_USART_BLE_RX 	    GPIOA
#define GPIO_USART_BLE_RX 	    GPIO3

#define PORT_USART_BLE_TX 	    GPIOA
#define GPIO_USART_BLE_TX 	    GPIO2

#define PORT_BLE_MODE 	        GPIOA
#define GPIO_BLE_MODE 	        GPIO0

#define PORT_BLE_RST    	    GPIOA
#define GPIO_BLE_RST 	        GPIO1
